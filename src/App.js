    ...
    <div className="app">
      ...
      <div className="bigFirstName">
        ...
        <div className="around">
          <div className="about">
            <h1 className="center spaceRight">About Me</h1>
            {/* 
              crypto
              spotify
              infra stuff
            ...
            */}
            ...
            <p className="spaceLeft">Technology, art, and the outdoors. What a weird combo, but those are things I love. Technology and art have this weird relationship of being so opposite yet connected. During college, this opposition morphed into a compatibility that I'm so fortunate I found. I studied computer science and minored in photography at Montana State University. What a beautiful state! This satisfied the three things I mentioned earlier and gave me insight to the differences and similarities of engineers and artists. 
